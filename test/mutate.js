...
const M = [
  ...
  ["拿掉 60 天邀請期的官方原文（面板上那個數字失去出處）",
    "' days from the date of your invitation to apply for the visa.&rdquo;</i>——'",
    "' days.&rdquo;</i>——'"],

  /* 那句原文只在 189 那一頁查得到，190／491 沒有替它背書。
     拿掉這句話等於默默替兩條沒查證過的路徑背書。 */
  ["拿掉「只在 189 那一頁查到」的適用範圍（等於替 190／491 背書）",
    "'<b>這句話我只在 189 那一頁查到。</b>190／491 走州提名，流程不一樣，'", "''"],
